  ...
  updateUser = async (email, nuevaInformacion) => {
    ...
    if (user.length > 0) {
      if (nuevaInformacion) {
        ...
        return {
          status: 400,
          response: "Ingresa la informacion a cambiar",
        };
      }
    } else {
      return {
        ...
        if (user.email) {
          await transport.sendMail({
            ...
            <div>
              ...
              <p>Lamentamos informarte que tu cuenta en nuestro sistema ha sido eliminada debido a inactividad. Si deseas volver a utilizar nuestros servicios, registrate nuevamente.</p>
            </div>
          `,
          });
        }
      ...
      await transport.sendMail({
        ...
        html: `
          <div>
            ...
            <p>Lamentamos informarte que tu cuenta en nuestro sistema ha sido eliminada. Si deseas volver a utilizar nuestros servicios, registrate nuevamente.</p>
          </div>
        `,
      });
      return {
